#!/usr/bin/env bash
# Start script for Validator 2

set -euo pipefail

VALIDATOR_PATH="/Users/chanthawat/Developments/gridtokenx-platform-infa/gridtokenx-anchor/scripts/poa-cluster/validators/validator-2"
GENESIS_LEDGER="/tmp/gridtokenx-poa/genesis/ledger"
VALIDATOR_LEDGER="/tmp/gridtokenx-poa/validators/validator-2/ledger"
RPC_PORT=8999
GOSSIP_PORT=8011
