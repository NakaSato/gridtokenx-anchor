...
describe("batch_settle THBC — TPS sweep (§2b)", () => {
  ...
  const matchAmount = 100 * 1_000_000_000, matchPrice = envInt("BENCH_TPS_PRICE", 2_000_000);
  ...
  before(async () => {
    // Treasury attestor may differ from the market authority (authority-drift when
