...
export const ENERGY_TOKEN_ERROR__INVALID_METADATA_ACCOUNT = 0x1773; // 6003

export type EnergyTokenError =
  | typeof ENERGY_TOKEN_ERROR__INSUFFICIENT_BALANCE
  | typeof ENERGY_TOKEN_ERROR__INVALID_METADATA_ACCOUNT
...
if (process.env.NODE_ENV !== 'production') {
  energyTokenErrorMessages = {
    ...
    [ENERGY_TOKEN_ERROR__INVALID_METADATA_ACCOUNT]: `Invalid metadata account`,
