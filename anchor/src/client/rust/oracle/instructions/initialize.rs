...
#[inline(always)]
    pub fn system_program(&mut self, system_program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn api_gateway(&mut self, api_gateway: Pubkey) -> &mut Self {
        self.api_gateway = Some(api_gateway);
        self
      }
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = Initialize {
          ...
          let args = InitializeInstructionArgs {
                                                              api_gateway: self.api_gateway.clone().expect("api_gateway is not set"),
                                    };
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn system_program(&mut self, system_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn api_gateway(&mut self, api_gateway: Pubkey) -> &mut Self {
        self.instruction.api_gateway = Some(api_gateway);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = InitializeInstructionArgs {
                                                              api_gateway: self.instruction.api_gateway.clone().expect("api_gateway is not set"),
                                    };
