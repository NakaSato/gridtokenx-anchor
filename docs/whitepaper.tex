...
% ============================================================================
\titleformat{\section}
    {\normalfont\Large\bfseries\color{griddark}}
    {\thesection}{1em}{}[\titlerule]
\titleformat{\subsection}
    {\normalfont\large\bfseries\color{gridblue}}
    {\thesubsection}{1em}{}
\titleformat{\subsubsection}
    {\normalfont\normalsize\bfseries\color{gridgreen}}
    {\thesubsubsection}{1em}{}
...
\begin{titlepage}
    ...
    \begin{highlightbox}
        \centering
        \textbf{1 GRID Token = 1 kWh of Verified Renewable Energy}
    \end{highlightbox}
