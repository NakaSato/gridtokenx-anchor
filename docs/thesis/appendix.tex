...
\hline
GridTokenX (Solana/PoA) & TPC-C & 352 & 11.30 & This Study \\
...
\begin{itemize}
  ...
  \item \textbf{Instance}: AWS ECS r7a.xlarge (4 vCPU, 32GB RAM)
...
\begin{equation}
\text{Trust Premium} = \frac{11.30\text{ms}}{2\text{ms}} = 5.65\times
\end{equation}
