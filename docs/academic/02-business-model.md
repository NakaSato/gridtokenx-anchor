...
│                                                        │                                   │
│  • Development and maintenance                         │  • Transaction fees (0.25-0.5%)   │
│  • Server infrastructure                               │  • ERC certificate issuance       │
│  • Regulatory compliance                               │  • Premium features               │
│  • Marketing and user acquisition                      │  • API access fees                │
...
|-------------------|-------------|-----------------|
| **Direct P2P Trading** | Trade energy directly with neighbors | No intermediary markup |
| **Instant Settlement** | Real-time payment on trade execution | vs. monthly billing |
| **Tokenized Energy** | 1 kWh = 1 GRID token | Liquid, tradable asset |
| **Verified Green** | On-chain ERC certificates | Immutable proof |
| **Multi-Currency** | GRID or Thai Baht payments | Flexibility |
...
| Payments | Multi-currency | Single currency | Flexibility |
